...
async function showMealDetails(id) {
    ...
    document.getElementById("main").innerHTML=html;
    //console.log("In show meal details");
}
            ...
            <div class="page-wrap d-flex flex-row align-items-center">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <div class="mb-4 lead">
                                No meal added in your favourites list.<br>
                                Add your favourites food.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5"> 
                            ...
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-dark" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:8%">Remove</button>
                        </div>
                    </div>
                </div>
                `;
